...
/***
 *<p>Construit une it�ration de simplexe avec comme tableau initiale matrix.
 * matrix est une matrice ayant la morphologie suivante :
 * <ul>
 * 	<li>La ligne 0, des colonnes 1 � variablesNumber+constraintsNumber: on a les coefficients de la fonction objective.</li>
 * 	<li>La ligne 0, colonne 0 contient la valeur de la fonction objective.</li>
 * 	<li>La colonne 0, des lignes 1 � constraintsNumber, on a le vecteur des membres de droite.</li>
 *  <li>La ligne 0, colonne 2+variablesNumber+constraintsNumber contient la variable de la fonction objective. </li>
 * 	<li>La colonne 2+variablesNumber+constraintsNumber, des lignes 1 � constraintsNumber on a la liste des varaibles de base.</li>
 * 	<li>Les lignes 1 � constraintsNumber et les colonnes 1 � variablesNumber+constraintsNumber : contiennent les coefficients des contraintes.</li>
 * </ul>
 * 
 *<p>Ainsi matrix doit �tre une matrice de dimension (1+constraintsNumber) x (2+variablesNumber+constraintsNumber). Si ce n'est le cas
 * le tableau du simplexe est initialialis� avec les dimensions ci-dessus et des 
 * valeurs par d�faut. 
 */
...
public class SimplexeIteration {
	...
	//Tableau simplexe initial et Tableau Simlplexe Resultat apr�s une It�ration.
	private Matrix matrix,result;
	
	//Si un cycle existe la variable cycle sera a true, sinon elle sera � false.
	...
	/**
	 * <p>Cr�er un tableau simplexe initiale avec z�ro comme valeur par d�faut. Ce tableau
	...
	/**
	 * 
	 * @return Tableau simplexe r�sultat.
	 */
	...
	/**
	 * <p>Affecte le nombre de variables et le nombre de contraintes, tout en cr�ant une
	 * matrice de dimension (1+constraintsNumber) x (2+variablesNumber+constraintsNumber).
	 * La matrice ainsi cr�er aura des valeurs nulles.
	 * 
	...
	/**
	 * Affecte un num�ro d'it�ration � cette instance.
	 * @param iterationNumber : Num�ro d'it�ration.
	 */
	...
	/**
	 * @return Num�ro de l'it�ration de l'instance.
	 */
	...
	/**
	 * @return true si la fonction objective est une fonction illimit�e.
	 */
	...
	/**
	 * 	
	 * @param m : Matrice dont on veut conna�tre l'optimalit�.
	...
	private void computeRealizableBasisSolution() {
		...
		if(pivot.getRow()!=-1 && pivot.getColumn()!=-1){
			...
			/*Initialise la matrice r�sultat*/
	...
	public String toString() {
		...
		valeur+="-- Probl�me de Programmation Lin�aire � r�soudre\n\n";		
		...
		if(!this.result.isEmpty()){		
			...
			valeur+=result+"\n\n";
			valeur+="-- R�sum� It�ration "+this.iterationNumber+".\n\n";
			valeur+="   Solution de base r�alisable : " ;
			valeur+="\n";
			...
			if(this.isInfiniteLoop()) valeur+="   Une boucle infinie a �t� d�tect�.\n";
			if(this.isUnlimitedFunction()) valeur+="   La Fonction Objective est une fonction illimit�e.\n";
			
		}else valeur+="  [Tableau  Simplexe R�sultat Vide]\n";
		return valeur+="\n";
	}
